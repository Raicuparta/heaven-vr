...
HeavenVR is a VR mod for [Neon White](https://store.steampowered.com/app/1533420/Neon_White/), with full motion control support and comfort options.
...
[Get HeavenVR on itch.io](https://raicuparta.itch.io/two-forks-vr). You can also use the [**itch.io app**](https://itch.io/app) to install the mod. This way you can get automatic updates.

Run `RaiManager.exe` (or click Open in the itch.io app) and follow the instructions in the installer.

## Requirements

- The latest version of Neon White.
- A PC ready for PCVR. HeavenVR doesn't work on standalone VR platforms.
