...
*   A legitimate and up to date version of Neon White ([get it on Steam](https://store.steampowered.com/app/1533420/Neon_White/)).
*   A PC ready for PCVR.
*   An OpenXR-compatible VR headset. Examples:
    *   Meta Quest connected to a PC via Link Cable, Air Link, Virtual Desktop, ALVR, etc
    *   Rift/Rift S
    *   Valve Index
    *   Any VIVE
